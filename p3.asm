...
main:                           # Program starts at main.
        ...
        la	$s0, total	# Register $t2 gets address of total
	...
	lw	$t4, 48($t1)	# Store array index 13 in $t4

	lw	$t5, 52($t1)	# Store array index 14 in $t5

	add	$s0, $t4, $t5   # Add $t4 and $t5

	lw	$t7, 56($t1)	# Store array index 15 in $t4

	add	$s0, $s0, $t7   # Add index 15($t4) to indices 13 and 14
